...
{
    public static final RegistryEntry<Block> MY_AWESOME_BLOCK = RegistryEntry.blockWithItem(ResourceLocation.fromNamespaceAndPath("registry_test", "awesome_block"), Block::new, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS));
