...
public abstract class Window extends Overlay implements LayoutElement
{
    ...
    public final void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick)
    {
        if(this.background != null)
        {
            ...
            graphics.blitSprite(this.background, this.layout.getX(), this.layout.getY(), this.layout.getWidth(), this.layout.getHeight());
    ...
    protected static abstract class Builder<B extends Builder<B, T>, T extends Window>
    {
         ...
         *
         * @param background a {@link ResourceLocation} to a sprite resource; can be null for transparent.
         * @return this {@link B} for method chaining
         */
        public B setBackground(@Nullable ResourceLocation background)
        {
            this.background = background;
            return this.self();
        }
