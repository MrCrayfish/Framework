...
public final class FrameworkButton extends AbstractButton
{
    ...
    public static class ToggleContentRenderer implements ContentRenderer<FrameworkButton>
    {
        ...
        public void extractContents(FrameworkButton button, GuiGraphicsExtractor extractor, int mouseX, int mouseY, float partialTick)
        {
            ...
            int alpha = ARGB.white(button.active ? 1.0F : 0.5F);
            extractor.blitSprite(RenderPipelines.GUI_TEXTURED, TOGGLE_SPRITES.get(this.state.get(), button.isHovered()), stateIconX, stateIconY, TOGGLE_SIZE, TOGGLE_SIZE, alpha);
        }
    }
