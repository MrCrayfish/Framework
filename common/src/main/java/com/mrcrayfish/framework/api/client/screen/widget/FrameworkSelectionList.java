 ...
 */
public class FrameworkSelectionList extends ObjectSelectionList<FrameworkSelectionList.Item> implements LayoutElement
{
    // Defaults for making the list replicate the visual style of vanilla's selection lists
    private static final ResourceLocation FRAMEWORK_WIDGETS_LOCATION = new ResourceLocation(Constants.MOD_ID, "textures/gui/widgets.png");
    public static final FrameworkTexture DEFAULT_BACKGROUND = FrameworkTexture.subImage(FRAMEWORK_WIDGETS_LOCATION, 0, 72, 64, 64);
    public static final ItemSprites DEFAULT_ITEM_SPRITE = ItemSprites.builder()
        .setEnabledSelected(FrameworkTexture.nineSlice(FRAMEWORK_WIDGETS_LOCATION, 0, 40, 128, 32, Border.of(1)))
        .setEnabledHoveredSelected(FrameworkTexture.nineSlice(FRAMEWORK_WIDGETS_LOCATION, 0, 40, 128, 32, Border.of(1)))
        .build();
    public static final Padding DEFAULT_LIST_PADDING = Padding.of(4);
    public static final Border DEFAULT_LIST_BORDER = Border.of(0);
    public static final ScrollerSprites DEFAULT_SCROLLER_SPRITE = ScrollerSprites.of(
        FrameworkTexture.nineSlice(FRAMEWORK_WIDGETS_LOCATION, 64, 72, 12, 32, Border.of(1))
    );
    public static final FrameworkTexture DEFAULT_SCROLL_BAR_BACKGROUND = FrameworkTexture.subImage(FRAMEWORK_WIDGETS_LOCATION, 76, 72, 12, 32);
    ...
    protected @Nullable FrameworkTexture listBackground;
    ...
    protected @Nullable FrameworkTexture scrollBarBackground;
    ...
    private FrameworkSelectionList(int x, int y, int width, int height, int itemHeight, @Nullable ItemSprites itemSprites, int itemSpacing, @Nullable FrameworkTexture listBackground, Border listBorder, Padding listPadding, boolean scrollBarAlwaysVisible, int scrollBarSpacing, ScrollBarStyle scrollBarStyle, @Nullable ScrollerSprites scrollerSprites, int scrollerWidth, int minScrollerHeight, @Nullable FrameworkTexture scrollBarBackground, Border scrollBarBorder, Padding scrollBarPadding, Padding scrollBarContainerPadding, @Nullable Supplier<Boolean> activeSupplier, @Nullable Consumer<Consumer<Item>> itemsSupplier)
    {
    ...
    {
        // TODO port what need to be here
    }
    ...
    public void setPosition(int x, int y)
    {
        ...
        //LayoutElement.super.setSize(this.width, this.height);
    }
    ...
    protected void renderListBackground(GuiGraphics graphics, int mouseX, int mouseY, float partialTick)
    {
        ...
        if(this.listBackground != null)
        {
            ...
            this.listBackground.draw(graphics, this.getX(), this.getY(), this.getListBackgroundWidth(), this.getListBackgroundHeight());
    ...
    protected void renderScrollBar(GuiGraphics graphics, int mouseX, int mouseY, float partialTick)
    {
        ...
        if(maxScroll > 0 || this.scrollBarAlwaysVisible)
        {
            ...
            if(this.scrollBarBackground != null)
            {
                ...
                this.scrollBarBackground.draw(graphics, scrollBarLeft, scrollBarTop, scrollBarAreaWidth, scrollBarAreaHeight);
                RenderSystem.disableBlend();
            }
            ...
            {
                FrameworkTexture texture = this.scrollerSprites.get(scrollBarEnabled, scrollBarHovered, this.scrolling);
                if(texture != null)
                {
                    RenderSystem.enableBlend();
                    RenderSystem.enableDepthTest();
                    graphics.setColor(1, 1, 1, this.active ? 1.0F : 0.5F);
                    texture.draw(graphics, scrollBarStart, scrollBarTop, scrollBarEnd - scrollBarStart, scrollBarHeight);
    ...
    {
        if(!this.active) // !this.isValidMouseClick(button) TODO port do I need this?
            return false;
    ...
    {
        return this.active && super.mouseScrolled(mouseX, mouseY, deltaY);
    }
    ...
    public Item removeItem(int index)
    {
        if(index >= 0 && index < this.children().size())
        {
            ...
            if(removed != null) this.setScrollAmount(this.getScrollAmount());
            return removed;
        }
        return null;
    }
    ...
    public boolean removeItem(Item item)
    {
        ...
        if(result) this.setScrollAmount(this.getScrollAmount());
        return result;
    }
    ...
    public static abstract class Item extends Entry<Item>
    {
        ...
        protected void renderBackground(@Nullable ItemSprites sprites, GuiGraphics graphics, int index, int x, int y, int width, int height, int mouseX, int mouseY, boolean hovered, boolean selected)
        {
            if(sprites != null)
            {
                FrameworkTexture texture = sprites.getSprite(true, hovered, selected);
                if(texture != null)
                {
    ...
    public static class Builder
    {
        ...
        private @Nullable FrameworkTexture listBackground = DEFAULT_BACKGROUND;
        ...
        private @Nullable FrameworkTexture scrollBarBackground = DEFAULT_SCROLL_BAR_BACKGROUND;
         ...
         * @return this {@link Builder} for method chaining
         */
        public Builder setListBackground(@Nullable FrameworkTexture texture)
        {
         ...
         * @return this {@link Builder} for method chaining
         */
        public Builder setScrollBarBackground(@Nullable FrameworkTexture texture)
        {
    ...
    public static final class ItemSprites
    {
        ...
        private ItemSprites(
                @Nullable FrameworkTexture enabled,
                @Nullable FrameworkTexture disabled,
                @Nullable FrameworkTexture enabledHovered,
                @Nullable FrameworkTexture disabledHovered,
                @Nullable FrameworkTexture enabledSelected,
                @Nullable FrameworkTexture disabledSelected,
                @Nullable FrameworkTexture enabledHoveredSelected,
                @Nullable FrameworkTexture disabledHoveredSelected)
        {
         ...
         */
        @Nullable
        public FrameworkTexture getSprite(boolean enabled, boolean hovered, boolean selected)
        {
         ...
         */
        public static ItemSprites of(@Nullable FrameworkTexture all)
        {
         ...
         */
        public static ItemSprites of(@Nullable FrameworkTexture enabled, @Nullable FrameworkTexture disabled, @Nullable FrameworkTexture enabledSelected)
        {
        ...
        public static class Builder
        {
            private @Nullable FrameworkTexture enabled;
            private @Nullable FrameworkTexture disabled;
            private @Nullable FrameworkTexture enabledHovered;
            private @Nullable FrameworkTexture disabledHovered;
            private @Nullable FrameworkTexture enabledSelected;
            private @Nullable FrameworkTexture disabledSelected;
            private @Nullable FrameworkTexture enabledHoveredSelected;
            private @Nullable FrameworkTexture disabledHoveredSelected;
             ...
             * @return this {@link Builder} for method chaining
             */
            public Builder setEnabled(@Nullable FrameworkTexture texture)
            {
             ...
             * @return this {@link Builder} for method chaining
             */
            public Builder setDisabled(@Nullable FrameworkTexture texture)
            {
             ...
             * @return this {@link Builder} for method chaining
             */
            public Builder setEnabledHovered(@Nullable FrameworkTexture texture)
            {
             ...
             * @return this {@link Builder} for method chaining
             */
            public Builder setDisabledHovered(@Nullable FrameworkTexture texture)
            {
             ...
             * @return this {@link Builder} for method chaining
             */
            public Builder setEnabledSelected(@Nullable FrameworkTexture texture)
            {
             ...
             * @return this {@link Builder} for method chaining
             */
            public Builder setDisabledSelected(@Nullable FrameworkTexture texture)
            {
             ...
             * @return this {@link Builder} for method chaining
             */
            public Builder setEnabledHoveredSelected(@Nullable FrameworkTexture texture)
            {
             ...
             * @return this {@link Builder} for method chaining
             */
            public Builder setDisabledHoveredSelected(@Nullable FrameworkTexture texture)
            {
    ...
    {
        private final FrameworkTexture enabled;
        private final @Nullable FrameworkTexture disabled;
        private final FrameworkTexture hovered;
        private final FrameworkTexture dragging;

        private ScrollerSprites(FrameworkTexture enabled, @Nullable FrameworkTexture disabled, FrameworkTexture hovered, FrameworkTexture dragging)
        {
        ...
        /**
         * Creates a {@link ScrollerSprites} instance with all states using the same {@link FrameworkTexture}.
         *
         ...
         */
        public static ScrollerSprites of(FrameworkTexture all)
        {
         ...
         */
        public static ScrollerSprites of(FrameworkTexture enabled, FrameworkTexture disabled, FrameworkTexture hovered)
        {
         ...
         * @return A new {@link ScrollerSprites} instance
         */
        public static ScrollerSprites of(FrameworkTexture enabled, FrameworkTexture disabled, FrameworkTexture hovered, FrameworkTexture dragging)
        {
            return new ScrollerSprites(enabled, disabled, hovered, dragging);
        }

        /**
         * Retrieves the appropriate {@link FrameworkTexture} based on the given state.
         *
         ...
         * @return The {@link FrameworkTexture}  corresponding to the specified state.
         */
        @Nullable
        public FrameworkTexture get(boolean enabled, boolean hovered, boolean dragging)
        {
