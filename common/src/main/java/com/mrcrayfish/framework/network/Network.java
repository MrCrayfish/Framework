...
{
    private static final FrameworkNetwork CONFIGURATION_CHANNEL = FrameworkAPI.createNetworkBuilder(Utils.rl("configuration"), 1)
    ...
    private static final FrameworkNetwork PLAY_CHANNEL = FrameworkAPI.createNetworkBuilder(Utils.rl("play"), 1)
