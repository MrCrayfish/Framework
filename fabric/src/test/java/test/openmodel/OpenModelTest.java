...
public class OpenModelTest implements ModInitializer
{
    ...
    private static final Block OPEN_MODEL_BLOCK_WITH_DATA = new Block(BlockBehaviour.Properties.copy(Blocks.GLASS));
    ...
    public void onInitialize()
    {
        ...
        Registry.register(Registry.BLOCK, new ResourceLocation("framework_test", "open_model_with_data"), OPEN_MODEL_BLOCK_WITH_DATA);
        Registry.register(Registry.ITEM, new ResourceLocation("framework_test", "open_model_with_data"), new BlockItem(OPEN_MODEL_BLOCK_WITH_DATA, new Item.Properties()));
    }
}
