...
public class DataLoaderTest
{
    ...
    public DataLoaderTest()
    {
        ...
        DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> bus.addListener(this::onFrameworkClientRegister));
    }

    private void onFrameworkClientRegister(FrameworkClientEvent.Register event)
    {
        event.registerDataLoader(new CustomLoader());
    }
